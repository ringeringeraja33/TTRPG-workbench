...
Apply [Keeper handout preflight](keeper-practice.md): creation date and wear, inspected variant, explicit release trigger/recipients, readable equivalent and checked rights. A failed decorative rendering falls back to the same evidence in plain text.
